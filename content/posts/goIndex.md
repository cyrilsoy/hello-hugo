...
![cfwk(5)](/files/goIndex/cfwk(5).png)

然后在上方找到`Workers`，选择后，点击页面下的`Add route`，进行如下设置。

![cfwk(6)](/files/goIndex/cfwk(6).png)

按照图中的格式，填上自己的域名，并选择对应的`Workers`程序即可。

![cfwk(7)](/files/goIndex/cfwk(7).png)
...
![cfwk(8)](/files/goIndex/cfwk(8).png)
...
![cfwk(9)](/files/goIndex/cfwk(9).png)

然后你会获得自己的客户端`ID`和客户端密钥，再复制下来。

![cfwk(10)](/files/goIndex/cfwk(10).png)
