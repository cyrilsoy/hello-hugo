...
![Github-Actions](/files/hugo-github-actions/tokens-1.png)

![Github-Actions](/files/hugo-github-actions/tokens-2.png)

 - 点 https://github.com/settings/tokens 新建一个，勾选 repo 和 workflow ,暂存；

![Github-Actions](/files/hugo-github-actions/secrets.jpeg)
